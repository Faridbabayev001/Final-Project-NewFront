...
@section('content')
  ...
  <div class="container">
     <div class="row">
          <h1 class="text-center">Yeni Dəstək</h1>
    </div>
  </div>
</div>
@if(Auth::user())
          ...
          <form  action="{{url('/destek-add')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="col-lg-6">
              ...
              <div class="form-group">
                ...
                <input type="email" name="email" class="form-control" placeholder="Password" value="{{Auth::user()->email}}">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label for="date">Dəstəyin müddəti</label>
                <input type="date" name="date" class="form-control" id="date">
              </div>
              <div class="form-group text-center">
                <input type="submit" class="btn" name ="send" value="GÖNDƏR">
              </div>
            </div>
          </form>
        </div>
